...
@Entity("inventoryConversionOutProducts", { schema: "myhomi" })
export class InventoryConversionOutProducts {
  ...
  @ManyToOne(
    () => InventoryConversion,
    (inventoryConversion) => inventoryConversion.inventoryConversionOutProducts,
  ...
  @ManyToOne(
    () => Products,
    (products) => products.inventoryConversionOutProducts,
    { onDelete: "RESTRICT", onUpdate: "RESTRICT" }
  )
